...
This walkthrough demonstrates a pattern that integrates a message driven architecture with a REST API driven architecture using Fuse Online.
...
This is not trivial because of the conflicting underlying timing models, and the data may require transformation to be acceptable.
...
To create a connector for your REST API, you register the OpenAPI definition as a Customization.
