...
Verify that you followed each step in the procedure above. In the *Settings* tab on the *Client* page, the *Enabled* toggle should be set to *ON*. If you are still having issues, contact your administrator.
