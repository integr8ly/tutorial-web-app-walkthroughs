...
. Click the _blue_ down-arrow icon to continue.
...
. Click all the _blue_ down-arrow icons to continue.
...
.. Click *Create Application Plan*. You are redirected to the *Application Plans* screen.
.. Click the *Publish* button.  Beside your plan list item, click the Publish button to publish the Plan.
