...
= Using API management to control API usage

:context: integrating-api-driven-applications

This walkthrough demonstrates how an API can be protected and rate limited.

As you modernize your application development, you create more APIs and it becomes important to control those APIs.
You may ask who is using the API and how can it be protected from a Denial-of-service attack?
It is possible to protect and limit access to an API using 3Scale as part of your integration.
