...
ifdef::route-fuse-flights-aggregator-host[]
[type=verification]
...
endif::route-fuse-flights-aggregator-host[]


ifndef::route-fuse-flights-aggregator-host[]

[WARNING]
====
The pods necessary to continue are not running.

Check that the following pods running in the link:{openshift-host}/console/project/{walkthrough-namespace}[OpenShift Project, window="_blank"]:

* fuse-flights-aggregator
* arrivals
* departures

When these pods are running, you can continue. 
====
endif::route-fuse-flights-aggregator-host[]
