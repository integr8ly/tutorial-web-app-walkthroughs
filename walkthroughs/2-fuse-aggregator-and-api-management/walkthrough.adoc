...
. Click the blue down-arrow icon to continue the wizard.
...
. Click all the blue down-arrow icons to continue the wizard, accepting the git repository name.

. Click the *Set Up Application* button to create a Git repository and provision the mission resources to OpenShift. A build for the *Fuse Aggregation App* will be triggered and deployed.
...
.. Click the *Publish* button, beside your plan list item, to publish the Plan.
