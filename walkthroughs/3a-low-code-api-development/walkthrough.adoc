...
. Select the *POST* tab in the *Design* section on the right.

. Click the *Add Operation* button within the *POST* section. 
A set of fields is displayed. 
...
. Click *Save* in the top right corner of the form to save your work. 
The *Review Actions* screen is displayed.
...
. When prompted to choose a connection, select your *Greeting Slack Target*.
...
The Integration flow should now list your Slack connection with a *Data Type* warning. 
