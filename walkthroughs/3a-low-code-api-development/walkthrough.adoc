...
. Click the *message* field in the *Source* panel, then click the *body* field in the *Target* panel. This maps the *message* value from the created Slack message to the *body* of the outgoing HTTP response.
...
.. Choose *Product: i-greeting-integration-{user-sanitized-username}* from the top navigation menu to view the {3scale-name} homepage.
+
