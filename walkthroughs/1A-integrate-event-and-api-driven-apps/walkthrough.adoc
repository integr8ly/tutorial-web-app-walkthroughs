...
To create this integration, use link:{enmasse-url}[AMQ Online, window="_blank", id="enmasse-url"] and API connectors in link:{fuse-url}[Red Hat Fuse Online, window="_blank", id="fuse-url"].
...
.Fuse Online
****
* link:{fuse-url}[Console, window="_blank", id="fuse-url"]
****

[type=walkthroughResource,serviceName=amq-online-standard]
.AMQ Online
****
* link:{enmasse-url}[Console, window="_blank", id="enmasse-url"]
****
...
. Log into link:{enmasse-url}[AMQ Online, window="_blank", id="enmasse-url"].
...
[type=verification]
Is the newly created address displayed on the *Addresses* screen of the link:{enmasse-url}[AMQ Online, window="_blank", id="enmasse-url"] console?
...
. Log in to the link:{fuse-url}[Red Hat Fuse Online, window="_blank", id="fuse-url"] console.
...
[type=verification]
Is the new connector displayed on the *Customizations* screen of the link:{fuse-url}[Red Hat Fuse Online, window="_blank", id="fuse-url"] console?
...
[type=verification]
Is the new connection displayed on the *Connections* screen of the link:{fuse-url}[Red Hat Fuse Online, window="_blank", id="fuse-url"] console?
...
[type=verification]
Is the integration displayed as *Running* on the *Integration* screen of the link:{fuse-url}[Red Hat Fuse Online, window="_blank", id="fuse-url"] console?
