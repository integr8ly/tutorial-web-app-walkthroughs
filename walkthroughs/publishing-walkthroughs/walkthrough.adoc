...
. Find and open the *Resources* menu on the left.

. Select the *Other Resources* menu item.

. Select *Web App* in the resources drop down.

. Click *Actions* and select *Edit YAML* in the resulting drop-down menu.

. Find the *Spec* > *Template* > *Parameters* entry in this YAML
. Add (or edit, if it already exists) a parameter:
+
----
...
----
+
NOTE: Make sure there are no space characters in the value of the *WALKTHROUGH_LOCATIONS*.
+
